...
void TimelineMarker_camera_set(PointerRNA *ptr, PointerRNA value, struct ReportList *reports)
{
    TimeMarker *data = (TimeMarker *)(ptr->data);
    ID *id = ptr->owner_id;
    if (id == value.data) {
...
StringPropertyRNA rna_TimelineMarker_name = {
	...
	0, -1, NULL},
	TimelineMarker_name_get, TimelineMarker_name_length, TimelineMarker_name_set, NULL, NULL, NULL, NULL, 0, 64, ""
};
